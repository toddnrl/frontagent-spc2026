      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="h-full w-full overflow-hidden bg-white shadow-[0_20px_60px_rgb(0,0,0,0.16)] sm:h-auto sm:w-[calc(100vw-32px)] sm:max-w-[420px] sm:rounded-[32px] sm:border sm:border-gray-100"
          >
